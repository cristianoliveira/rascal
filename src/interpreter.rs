    ...
    pub fn eval_tree(&mut self, tree: Node) -> String {
        ...
        match *operation.clone() {
            ...
            Operation::DefineImut(lnode, rnode) => {
                ...
                self.frame.ilocals.insert(name, value.clone());
                value
            },
            ...
            Operation::DefineVar(lnode, rnode) => {
                ...
                self.frame.locals.insert(name, value.clone());
                value
            },
            ...
            Operation::ReAssign(lnode, rnode) => {
                ...
                if self.frame.is_imutable(&*name) {
            ...
            Operation::Identifier(name) => self.frame.get(&*name),
...
fn it_eval_block_assigning_vars_to_symbol_table() {
    ...
    assert_eq!("10", interpreter.frame.locals["x"]);
}
...
fn it_eval_block_retrieve_vars_from_symbol_table() {
    ...
    assert_eq!("10", interpreter.frame.ilocals["x"]);
    assert_eq!("15", interpreter.frame.locals["y"]);
}
